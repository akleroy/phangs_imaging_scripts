...
# 
# How to run:
#   casapy-5.4.0 --nogui --log2term -c "exec(open('test_scripts/unittest_handlerVis.py','r').read())"
# 
# TODO: 
...
class test_uvdata_handler(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.uvdata_handler = handlerVis.UVDataHandler(key_handler = cls.key_handler)
