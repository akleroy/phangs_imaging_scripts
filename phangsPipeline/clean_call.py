...
class CleanCall:
    ...
    def __init__(self, infile=None):
        ...
        #########################################
        # Parameters that go directly to tclean #
        #########################################
        
        self.clean_params = {}
        self.read_params_from_file(infile)
        
        ############################################
        # Parameters used by the CleanCall object. #
        ############################################

        # File to log the procedure
        self.logfile = None
    ...
    def set(self, key, value, nowarning=False):
        """
        Generic setter that accepts field as a text string. Can only
        set attributed already defined for the object.
        """
    ...
    def read_params_from_file(self, fname=None):
        """
    ...
    def get_cell_in_arcsec(self):
        ...
        if type(self.cell) == type([]):
            cell_string = self.cell[0]
        else:
            cell_string = self.cell
    ...
    def get(self, key=None):
        ...
        if hasattr(self, key):
            ...
            raise Exception('CleanCall does not have an attribute named "'+str(key)+'"')
            return(None)
