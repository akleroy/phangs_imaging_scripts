...
#$ -cwd -j y
#$ -o casa_imaging_per_chunk.$JOB_ID.$TASK_ID.log
#$ -q mThC.q
#$ -pe mthread 4
#$ -l mres=16G,h_data=4G,h_vmem=4G
#$ -N casa_imaging_per_chunk

# Update to the correct number of chunks to run
#$ -t 1-10
...
set casa_script = run_casa_imaging_perchunk.py
