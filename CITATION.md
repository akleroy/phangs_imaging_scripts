If you use these programs, we request that you acknowledge their use by citing the PHANGS-ALMA data reduction pipeline paper, which presents the software:
