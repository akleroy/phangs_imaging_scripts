...
out_root = 'ngc1385'
tag = '925'
phase_center = 'J2000 03h37m28.8s -24d30m01s'
source_vel_kms = 1499.
vwidth_kms = 500.

calibrated_files = {
    '7m':'../../2015.1.00925.S/science_goal.uid___A001_X2fe_X2ce/group.uid___A001_X2fe_X2cf/member.uid___A001_X2fe_X2d2/calibrated/calibrated_final.ms'
    #, '12m':''
    }
...
if script_image_chan0:
    ...
    if script_image_co21:
        ...
        input_vis = 'ngc1385_925_co21_chan0.ms'
        cube_root = 'ngc1385_co21_chan0'
        uvtaper = None
        linetag = 'co21'
        specmode = 'mfs'
        restfreq_ghz = line_list[linetag]
    ...
    if script_image_c18o21:
        do_end_to_end = True
        do_start_with_pbmask = True
        input_vis = 'ngc1385_925_c18o21_chan0.ms'
        cube_root = 'ngc1385_c18o21_chan0'
        uvtaper = None
        linetag = 'c18o21'
        specmode = 'mfs'
        restfreq_ghz = line_list[linetag]
    ...
    if script_image_cont:
        do_end_to_end = True
        do_start_with_pbmask = True
        input_vis = 'ngc1385_925_cont.ms'
        cube_root = 'ngc1385_cont'
        uvtaper = None
        specmode = 'mfs'
        restfreq_ghz = ''
        execfile('../scripts/imageImage.py')
...
if script_image_cube:
    ...
    if script_image_co21:
        ...
        input_vis = 'ngc1385_925_co21.ms'
        cube_root = 'ngc1385_co21'
        uvtaper = None
        linetag = 'co21'
        specmode = 'cube'
    ...
    if script_image_c18o21:
        ...
        input_vis = 'ngc1385_925_c18o21.ms'
        cube_root = 'ngc1385_c18o21'
        uvtaper = None
        linetag = 'c18o21'
        specmode = 'cube'
        restfreq_ghz = line_list[linetag]
